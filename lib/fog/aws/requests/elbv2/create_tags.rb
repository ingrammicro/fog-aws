  ...
  module AWS
    class ELBV2
      class Real
        ...
        #
        # ==== Parameters
        # * resources <~String> - The Amazon Resource Name (ARN) of the resource.
        ...
        def create_tags(resources, tags)
          params = {}
          params.merge!(Fog::AWS.indexed_param('Tags.member.%d.Key', tags.keys))
          params.merge!(Fog::AWS.indexed_param('Tags.member.%d.Value', tags.values))
          p params
          request({
              'Action'                      => 'AddTags',
